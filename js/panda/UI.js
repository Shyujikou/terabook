...
this['背景']=this['画像']['作る']();
this['背景']['変更'](((((((root['画像パス'])+"panda/")+(root['ファイル名']))))));
this['背景']['大きさ']((root['画面幅']),(root['画面高さ']));
this['背景']['位置'](((-(1)*((root['画面幅']/(2))))),((root['画面高さ']/(2))));
this['じっこうボタン']=this['画像']['作る']();
this['じっこうボタン']['変更']((((root['画像パス']+"panda/button1.png"))));
this['じっこうボタン']['ホバー画像']((((root['画像パス']+"panda/button1-hover.png"))));
...
this['やりなおしボタン']['変更']((((root['画像パス']+"panda/button2.png"))));
this['やりなおしボタン']['ホバー画像']((((root['画像パス']+"panda/button2-hover.png"))));
