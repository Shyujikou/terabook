...
this['座標辞書']['書く']("9?x",(((((-(250)+this['開始位置x'])+((this['ピクセルの横間隔']*(8)))))*this['横の拡大倍率'])));
this['座標辞書']['書く']("10?x",(((((-(250)+this['開始位置x'])+((this['ピクセルの横間隔']*(9)))))*this['横の拡大倍率'])));
...
this['座標辞書']['書く']("?8y",(((((((175)-this['開始位置y'])-(0))-((this['ピクセルの縦間隔']*(7)))))*this['縦の拡大倍率'])));
this['座標辞書']['書く']("?9y",((((((175)-this['開始位置y'])-((this['ピクセルの縦間隔']*(8)))))*this['縦の拡大倍率'])));
this['座標辞書']['書く']("?10y",((((((175)-this['開始位置y'])-((this['ピクセルの縦間隔']*(9)))))*this['縦の拡大倍率'])));
...
this['座標辞書']['書く']("7?w",((this['ピクセルの横間隔']*this['横の拡大倍率'])));
this['座標辞書']['書く']("9?w",((this['ピクセルの横間隔']*this['横の拡大倍率'])));
this['座標辞書']['書く']("10?w",((this['ピクセルの横間隔']*this['横の拡大倍率'])));
...
this['座標辞書']['書く']("?8h",((this['ピクセルの縦間隔']*this['縦の拡大倍率'])));
this['座標辞書']['書く']("?9h",((this['ピクセルの縦間隔']*this['縦の拡大倍率'])));
this['座標辞書']['書く']("?10h",((this['ピクセルの縦間隔']*this['縦の拡大倍率'])));
this['じっこうボタンの幅']=((130)*this['横の拡大倍率']);
this['じっこうボタンのx座標']=(((-(5)*this['横の拡大倍率']))-(root['じっこうボタンの幅']));
this['じっこうボタンのy座標']=(-(140)*this['縦の拡大倍率']);
this['やりなおしボタンの幅']=((130)*this['横の拡大倍率']);
this['やりなおしボタンのx座標']=(((5)*this['横の拡大倍率']));
this['やりなおしボタンのy座標']=(-(140)*this['縦の拡大倍率']);
this['画面配置']['実行']();
this['ピクセルの色']="black";
...
//# sourceMappingURL=Panda_hard3_300.js.map
