...
root['メッセージ初期化']['実行']();
this['ドローン']['_初期化']();
this['フルーツたち']['それぞれ実行'](dtlbind(this,function(要素){
var self=this;var 自分=self;
return 要素['_初期化']();
}));
...
this['命令部']['クリア']();
this['ドローン']['_初期化']();
return this['フルーツたち']['それぞれ実行'](dtlbind(this,function(要素){
var self=this;var 自分=self;
return 要素['_初期化']();
}));
}));
...
return this['ひとつもどるボタン']['ホバー画像']((((root['画像パス']+"mammoth/button/button3-hover.png?")+(((255)).乱数()))));
});
