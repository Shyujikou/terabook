...
this['をつくろう']['zIndex'](-(1));
this['をつくろう']['変更']((((root['画像パス']+"herring/parts1.png?")+(((255)).乱数()))));
this['をつくろう']['位置']((this['をつくろうの左上x']),(this['をつくろうの左上y']));
this['をつくろう']['大きさ']((this['をつくろうの幅']));
this['OKボタン']=this['画像']['作る']((((root['画像パス']+"herring/button1.png?")+(((255)).乱数()))));
...
this['OKボタン']['ホバー画像']((((root['画像パス']+"herring/button1-hover.png?")+(((255)).乱数()))));
...
this['やりなおしボタン']=this['画像']['作る']((((root['画像パス']+"herring/button2.png?")+(((255)).乱数()))));
...
this['やりなおしボタン']['ホバー画像']((((root['画像パス']+"herring/button2-hover.png?")+(((255)).乱数()))));
...
this['次の問題へボタン']=this['画像']['作る']((((root['画像パス']+"herring/button3.png?")+(((255)).乱数()))));
...
this['次の問題へボタン']['ホバー画像']((((root['画像パス']+"herring/button3-hover.png?")+(((255)).乱数()))));
